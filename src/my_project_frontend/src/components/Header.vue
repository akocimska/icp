...
<template>
  <main class="bg-slate-700">
    ...
    <form action="#" @submit="handleSubmit" class="flex flex-col gap-4 justify-center items-center">
      ...
      <button type="submit" class="bg-gradient-to-r from-violet-300 to-violet-950 txt-violet-50 p-2 rounded-lg">Click Me!</button>
    </form>
    <section id="greeting" class="text-6xl p-6 flex flex-col gap-4 justify-center items-center" >{{ greeting }}</section>
  </main>
</template>
<script>
export default {
